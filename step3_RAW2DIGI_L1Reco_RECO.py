...
# with command line options: step3 --conditions auto:run2_mc_hi -s RAW2DIGI,L1Reco,RECO n 2 --eventcontent RECOSIM --scenario HeavyIons --datatier GEN-SIM-RECO --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 --no_exec --filein file:GENSIMRAW.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2_run2_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco.root'),
