...
# with command line options: step3 --conditions auto:run2_mc_HIon -s RAW2DIGI,L1Reco,RECO -n 50 --eventcontent RECOSIM --scenario HeavyIons --datatier RECO --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd.cmsaf.mit.edu//store/user/twang/ZEE_5TeV_GEN_SIM_PU/ZEE_5TeV_GEN_SIM_PU_step2/f3950ab07bbd1716ce99d1da3e903b99/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_PU_101_1_eJf.root'),
