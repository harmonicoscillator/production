...
# with command line options: step3 --conditions 75X_dataRun2_v13 --scenario HeavyIons --eventcontent RECO -s RAW2DIGI,L1Reco,RECO --datatier RECO --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --filein file:RAW.root --fileout file:RECO.root --no_exec --repacked
