...
process.source = cms.Source("PoolSource",
                            ...
                            #)
                            fileNames = cms.untracked.vstring('/store/data/Run2013A/PPPhoton/RECO/PromptReco-v1/000/211/739/00000/5028BC0F-9376-E211-BD03-001D09F24763.root')
)
...
overrideJEC_localGammaJet_pp5020(process)
...
process.pACentrality.producePixelTracks = False
process.pACentrality.srcTracks = cms.InputTag("generalTracks")
process.pACentrality.srcVertex = cms.InputTag("offlinePrimaryVerticesWithBS")
