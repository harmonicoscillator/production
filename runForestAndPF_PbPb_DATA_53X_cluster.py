...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring(
                                "/store/user/richard/HIHighPt/HI_PFElectron_misReconstruction/fb2408a63905cd9c4f8c123a8bd6a745/pickevents_100_2_9Zf.root",
...
process.jetSequences = cms.Sequence(#process.akPu2CaloJetSequence +
...
process.rereco_step = cms.Path(process.hiPixel3PrimTracks +
...
### Set of Cuts 1, just the seed threshold ###
### both options are available, not sure which one is "real"
...
### Set of additional cuts for 95% purity ###
## delta-R cut ##
#process.ecalDrivenElectronSeeds.SeedConfiguration.z2MinB = cms.double(-0.0774) ## barrel
#process.ecalDrivenElectronSeeds.SeedConfiguration.z2MaxB = cms.double(0.0774) ## barrel
#process.ecalDrivenElectronSeeds.SeedConfiguration.r2MinF = cms.double(-0.1238) ## forward
#process.ecalDrivenElectronSeeds.SeedConfiguration.r2MaxF = cms.double(0.1238) ## forward

## delta-phi cut missing?

### Set of additional cuts for 90% purity ###
## delta-R cut ##
# process.ecalDrivenElectronSeeds.z2MinB = cms.double(-0.0696) ## barrel
# process.ecalDrivenElectronSeeds.z2MaxB = cms.double(0.0696) ## barrel
# process.ecalDrivenElectronSeeds.r2MinF = cms.double(-0.117) ## forward
# process.ecalDrivenElectronSeeds.r2MaxF = cms.double(0.117) ## forward
