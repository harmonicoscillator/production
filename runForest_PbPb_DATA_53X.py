...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring("/store/hidata/HIRun2011/HIHighPt/RECO/14Mar2014-v2/00000/00A2A3D5-DCB8-E311-AA3A-FA163EBE44E1.root")
                            )
...
process.skimFilter.HLTPaths = ["HLT_HISinglePhoton*", "HLT_HIDoublePhoton*", "HLT_HIPhoton*"]
