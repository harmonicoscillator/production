...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring(
                                "/store/himc/HiWinter13/Pyquen_Unquenched_AllQCDPhoton120_PhotonFilter35GeV_eta3_TuneZ2_reversepPb_5020GeV/GEN-SIM-RECO/pa_mixing_STARTHI53_V27-v1/00000/0235A824-FC41-E411-B09B-008CFA0020D4.root"
                            ))
...
from HeavyIonsAnalysis.Configuration.CommonFunctionsLocalDBGammaJet_cff import overrideCentrality
#from HeavyIonsAnalysis.Configuration.CommonFunctionsLocalDBGammaJet_cff import overrideJEC_localGammaJet_pPb5020
from HeavyIonsAnalysis.Configuration.CommonFunctionsLocalDBGammaJet_cff import overrideJEC_localGammaJet_Pbp5020
#from HeavyIonsAnalysis.Configuration.CommonFunctionsLocalDBGammaJet_cff import overrideJEC_localGammaJet_pp5020

overrideCentrality(process)
overrideJEC_localGammaJet_Pbp5020(process)
...
process.multiPhotonAnalyzer.gsfElectronCollection = cms.untracked.InputTag("gsfElectrons")
