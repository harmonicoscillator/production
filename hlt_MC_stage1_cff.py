# /users/cfmcginn/testHLT/HI_DEV_port/V19 (CMSSW_7_4_0)
...
fragment.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/cfmcginn/testHLT/HI_DEV_port/V19')
)
...
fragment.hltPrePuAK3CaloJet40 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
fragment.hltPuAK3CaloJets = cms.EDProducer( "FastjetJetProducer",
...
fragment.hltPuAK3CaloJetsIDPassed = cms.EDProducer( "HLTCaloJetIDProducer",
    min_N90 = cms.int32( -2 ),
    min_N90hits = cms.int32( 2 ),
    min_EMF = cms.double( 1.0E-6 ),
    jetsInput = cms.InputTag( "hltPuAK3CaloJets" ),
...
fragment.hltPuAK3CaloJetsCorrected = cms.EDProducer( "CaloJetCorrectionProducer",
    src = cms.InputTag( "hltPuAK3CaloJets" ),
    correctors = cms.vstring( 'hltESPAK4CaloCorrection' )
)
fragment.hltPuAK3CaloJetsCorrectedIDPassed = cms.EDProducer( "CaloJetCorrectionProducer",
    src = cms.InputTag( "hltPuAK3CaloJetsIDPassed" ),
    correctors = cms.vstring( 'hltESPAK4CaloCorrection' )
)
fragment.hltSinglePuAK3CaloJet40 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 40.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
    MinMass = cms.double( -1.0 ),
    inputTag = cms.InputTag( "hltPuAK3CaloJetsCorrectedIDPassed" ),
    MinE = cms.double( -1.0 ),
...
fragment.hltPrePuAK3CaloJet50 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK3CaloJet50 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
fragment.hltPrePuAK3CaloJet60 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK3CaloJet60 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
fragment.hltPrePuAK3CaloJet70 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK3CaloJet70 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
fragment.hltPrePuAK3CaloJet80 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK3CaloJet80 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
fragment.hltPrePuAK3CaloJet100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK3CaloJet100 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
fragment.hltPrePuAK3CaloJet120 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK3CaloJet120 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
...
fragment.hltPrePuAK4CaloJet40 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
fragment.hltPuAK4CaloJetsCorrected = cms.EDProducer( "CaloJetCorrectionProducer",
    src = cms.InputTag( "hltPuAK4CaloJets" ),
    correctors = cms.vstring( 'hltESPAK4CaloCorrection' )
)
fragment.hltPuAK4CaloJetsCorrectedIDPassed = cms.EDProducer( "CaloJetCorrectionProducer",
    src = cms.InputTag( "hltPuAK4CaloJetsIDPassed" ),
    correctors = cms.vstring( 'hltESPAK4CaloCorrection' )
)
fragment.hltSinglePuAK4CaloJet40 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 40.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
fragment.hltPrePuAK4CaloJet80 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK4CaloJet80 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 80.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
fragment.hltPrePuAK4CaloJet100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK4CaloJet100 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 100.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
fragment.hltPrePuAK4CaloJet120 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK4CaloJet120 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 120.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
fragment.hltPreCaloJet40 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
fragment.hltPreCaloJet80 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
fragment.hltPrePuAK5CaloJet40 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltPuAK5CaloJets = cms.EDProducer( "FastjetJetProducer",
    Active_Area_Repeats = cms.int32( 5 ),
    doAreaFastjet = cms.bool( False ),
    voronoiRfact = cms.double( 0.9 ),
    maxBadHcalCells = cms.uint32( 9999999 ),
...
fragment.hltPuAK5CaloJetsIDPassed = cms.EDProducer( "HLTCaloJetIDProducer",
    min_N90 = cms.int32( -2 ),
    min_N90hits = cms.int32( 2 ),
    min_EMF = cms.double( 1.0E-6 ),
    jetsInput = cms.InputTag( "hltPuAK5CaloJets" ),
    JetIDParams = cms.PSet( 
      useRecHits = cms.bool( True ),
      hbheRecHitsColl = cms.InputTag( "hltHbhereco" ),
      hoRecHitsColl = cms.InputTag( "hltHoreco" ),
...
fragment.hltPuAK5CaloJetsCorrected = cms.EDProducer( "CaloJetCorrectionProducer",
    src = cms.InputTag( "hltPuAK5CaloJets" ),
    correctors = cms.vstring( 'hltESPAK4CaloCorrection' )
)
fragment.hltPuAK5CaloJetsCorrectedIDPassed = cms.EDProducer( "CaloJetCorrectionProducer",
    src = cms.InputTag( "hltPuAK5CaloJetsIDPassed" ),
    correctors = cms.vstring( 'hltESPAK4CaloCorrection' )
)
fragment.hltSinglePuAK5CaloJet40 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 40.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
    MinMass = cms.double( -1.0 ),
    inputTag = cms.InputTag( "hltPuAK5CaloJetsCorrectedIDPassed" ),
    MinE = cms.double( -1.0 ),
    triggerType = cms.int32( 85 )
)
fragment.hltPrePuAK5CaloJet80 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
fragment.hltSinglePuAK5CaloJet80 = cms.EDFilter( "HLT1CaloJet",
    saveTags = cms.bool( True ),
    MinPt = cms.double( 80.0 ),
    MinN = cms.int32( 1 ),
    MaxEta = cms.double( 5.0 ),
...
fragment.hltL1sL1SingleEG2 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ZeroBias" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
...
fragment.HLTPuAK3CaloJetsReconstructionSequence = cms.Sequence( fragment.HLTDoCaloSequence + fragment.hltPuAK3CaloJets + fragment.hltPuAK3CaloJetsIDPassed )
fragment.HLTPuAK3CaloJetsCorrectionSequence = cms.Sequence( fragment.hltFixedGridRhoFastjetAllCalo + fragment.hltPuAK3CaloJetsCorrected + fragment.hltPuAK3CaloJetsCorrectedIDPassed )
fragment.HLTPuAK3CaloJetsSequence = cms.Sequence( fragment.HLTPuAK3CaloJetsReconstructionSequence + fragment.HLTPuAK3CaloJetsCorrectionSequence )
...
fragment.HLTPuAK4CaloJetsCorrectionSequence = cms.Sequence( fragment.hltFixedGridRhoFastjetAllCalo + fragment.hltPuAK4CaloJetsCorrected + fragment.hltPuAK4CaloJetsCorrectedIDPassed )
...
fragment.HLTPuAK5CaloJetsReconstructionSequence = cms.Sequence( fragment.HLTDoCaloSequence + fragment.hltPuAK5CaloJets + fragment.hltPuAK5CaloJetsIDPassed )
fragment.HLTPuAK5CaloJetsCorrectionSequence = cms.Sequence( fragment.hltFixedGridRhoFastjetAllCalo + fragment.hltPuAK5CaloJetsCorrected + fragment.hltPuAK5CaloJetsCorrectedIDPassed )
fragment.HLTPuAK5CaloJetsSequence = cms.Sequence( fragment.HLTPuAK5CaloJetsReconstructionSequence + fragment.HLTPuAK5CaloJetsCorrectionSequence )
...
fragment.HLT_PuAK3CaloJet40_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK3CaloJet40 + fragment.HLTPuAK3CaloJetsSequence + fragment.hltSinglePuAK3CaloJet40 + fragment.HLTEndSequence )
fragment.HLT_PuAK3CaloJet50_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK3CaloJet50 + fragment.HLTPuAK3CaloJetsSequence + fragment.hltSinglePuAK3CaloJet50 + fragment.HLTEndSequence )
fragment.HLT_PuAK3CaloJet60_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK3CaloJet60 + fragment.HLTPuAK3CaloJetsSequence + fragment.hltSinglePuAK3CaloJet60 + fragment.HLTEndSequence )
fragment.HLT_PuAK3CaloJet70_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK3CaloJet70 + fragment.HLTPuAK3CaloJetsSequence + fragment.hltSinglePuAK3CaloJet70 + fragment.HLTEndSequence )
fragment.HLT_PuAK3CaloJet80_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK3CaloJet80 + fragment.HLTPuAK3CaloJetsSequence + fragment.hltSinglePuAK3CaloJet80 + fragment.HLTEndSequence )
fragment.HLT_PuAK3CaloJet100_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK3CaloJet100 + fragment.HLTPuAK3CaloJetsSequence + fragment.hltSinglePuAK3CaloJet100 + fragment.HLTEndSequence )
fragment.HLT_PuAK3CaloJet120_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK3CaloJet120 + fragment.HLTPuAK3CaloJetsSequence + fragment.hltSinglePuAK3CaloJet120 + fragment.HLTEndSequence )
fragment.HLT_PuAK4CaloJet40_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK4CaloJet40 + fragment.HLTPuAK4CaloJetsSequence + fragment.hltSinglePuAK4CaloJet40 + fragment.HLTEndSequence )
fragment.HLT_PuAK4CaloJet80_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK4CaloJet80 + fragment.HLTPuAK4CaloJetsSequence + fragment.hltSinglePuAK4CaloJet80 + fragment.HLTEndSequence )
fragment.HLT_PuAK4CaloJet100_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK4CaloJet100 + fragment.HLTPuAK4CaloJetsSequence + fragment.hltSinglePuAK4CaloJet100 + fragment.HLTEndSequence )
fragment.HLT_PuAK4CaloJet120_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK4CaloJet120 + fragment.HLTPuAK4CaloJetsSequence + fragment.hltSinglePuAK4CaloJet120 + fragment.HLTEndSequence )
fragment.HLT_CaloJet40_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1ZeroBias + fragment.hltPreCaloJet40 + fragment.HLTAK4CaloJetsSequence + fragment.hltSingleCaloJet40 + fragment.HLTEndSequence )
fragment.HLT_CaloJet80_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1ZeroBias + fragment.hltPreCaloJet80 + fragment.HLTAK4CaloJetsSequence + fragment.hltSingleCaloJet80 + fragment.HLTEndSequence )
fragment.HLT_PuAK5CaloJet40_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK5CaloJet40 + fragment.HLTPuAK5CaloJetsSequence + fragment.hltSinglePuAK5CaloJet40 + fragment.HLTEndSequence )
fragment.HLT_PuAK5CaloJet80_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleJet16BptxAND + fragment.hltPrePuAK5CaloJet80 + fragment.HLTPuAK5CaloJetsSequence + fragment.hltSinglePuAK5CaloJet80 + fragment.HLTEndSequence )
fragment.HLT_HISinglePhoton10_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleEG2 + fragment.hltPreHISinglePhoton60 + fragment.HLTDoCaloSequence + fragment.HLTDoHIEcalClusWithCleaningSequence + fragment.hltHIPhoton10 + fragment.HLTEndSequence )
fragment.HLT_HISinglePhoton15_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleEG2 + fragment.hltPreHISinglePhoton60 + fragment.HLTDoCaloSequence + fragment.HLTDoHIEcalClusWithCleaningSequence + fragment.hltHIPhoton15 + fragment.HLTEndSequence )
fragment.HLT_HISinglePhoton20_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleEG2 + fragment.hltPreHISinglePhoton60 + fragment.HLTDoCaloSequence + fragment.HLTDoHIEcalClusWithCleaningSequence + fragment.hltHIPhoton20 + fragment.HLTEndSequence )
fragment.HLT_HISinglePhoton40_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleEG2 + fragment.hltPreHISinglePhoton60 + fragment.HLTDoCaloSequence + fragment.HLTDoHIEcalClusWithCleaningSequence + fragment.hltHIPhoton40 + fragment.HLTEndSequence )
fragment.HLT_HISinglePhoton60_v1 = cms.Path( fragment.HLTBeginSequence + fragment.hltL1sL1SingleEG2 + fragment.hltPreHISinglePhoton60 + fragment.HLTDoCaloSequence + fragment.HLTDoHIEcalClusWithCleaningSequence + fragment.hltHIPhoton60 + fragment.HLTEndSequence )
...
fragment.HLTSchedule = cms.Schedule( *(fragment.HLTriggerFirstPath, fragment.HLT_PuAK3CaloJet40_v1, fragment.HLT_PuAK3CaloJet50_v1, fragment.HLT_PuAK3CaloJet60_v1, fragment.HLT_PuAK3CaloJet70_v1, fragment.HLT_PuAK3CaloJet80_v1, fragment.HLT_PuAK3CaloJet100_v1, fragment.HLT_PuAK3CaloJet120_v1, fragment.HLT_PuAK4CaloJet40_v1, fragment.HLT_PuAK4CaloJet80_v1, fragment.HLT_PuAK4CaloJet100_v1, fragment.HLT_PuAK4CaloJet120_v1, fragment.HLT_CaloJet40_v1, fragment.HLT_CaloJet80_v1, fragment.HLT_PuAK5CaloJet40_v1, fragment.HLT_PuAK5CaloJet80_v1, fragment.HLT_HISinglePhoton10_v1, fragment.HLT_HISinglePhoton15_v1, fragment.HLT_HISinglePhoton20_v1, fragment.HLT_HISinglePhoton40_v1, fragment.HLT_HISinglePhoton60_v1, fragment.HLTriggerFinalPath, fragment.HLTAnalyzerEndpath ))
